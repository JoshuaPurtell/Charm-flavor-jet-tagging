...
int main( int argc, const char** argv ){
    ...
    cout << "  * args are:   "                           << endl
         << "  * 1: nEvents              |  30     "     << endl
         << "  * 2: fout_name            |  out_test_PM.root   " << endl
    ...
    fout_name           = (argc > 2)  ? argv[2]        : "out_test_PM.root";
    ...
    TTree* tree_test = new TTree("tree_test", "jet by jet");
    tree_test->Branch("mass_var", &mass_var, "mass_var/F");
    tree_test->Branch("decay_length_var", &decay_length_var, "decay_length_var/F");
    tree_test->Branch("pk_dca_var1", &pk_dca_var1, "pk_dca_var1/F");
    tree_test->Branch("pk_dca_var2", &pk_dca_var2, "pk_dca_var2/F");
    tree_test->Branch("trx_dca_var", &trx_dca_var, "trx_dca_var/F");
    tree_test->Branch("pointing_angle_var", &pointing_angle_var, "pointing_angle_var/F"); 
    tree_test->Branch("Drecon_dca_var", &Drecon_dca_var, "Drecon_dca_var/F");
    tree_test->Branch("dca_angle_var",&dca_angle_var,"dca_angle_var/F");
    tree_test->Branch("Z_jet_dmeson_var",&Z_jet_dmeson_var,"Z_jet_dmeson_var/F");
    tree_test->Branch("paths_area_var",&paths_area_var,"paths_area_var/F");
    tree_test->Branch("pk_p_frac_var",&pk_p_frac_var,"pk_p_frac_var/F");
    tree_test->Branch("validation_var", &validation_var, "validation_var/I");
    tree_test->Branch("efficiency_pass_var",&efficiency_pass_var,"efficiency_pass_var/F");
    tree_test->Branch("dmesonp_mag_var",&dmesonp_mag_var,"dmesonp_mag_var/F");
    tree_test->Branch("jetp_mag_var",&jetp_mag_var,"jetp_mag_var/F");
